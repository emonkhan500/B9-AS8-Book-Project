...
const ListedBook = () => {
	...
	<Link onClick={()=>setIndx(1)} 
    to={`wish`}
     rel="`noopener noreferrer" href="#" className={`flex items-center flex-shrink-0 px-5 py-3 space-x-2  ${indx===1 ?'border border-b-0':'border-b'} rounded-t-lg border-gray-400 text-gray-50`}>
