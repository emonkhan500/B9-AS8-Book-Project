...
const Banner = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse mt-10 mb-10">
    ...
    <div>
      <h1 className="text-5xl font-bold mb-9">Books to freshen up  your own bookshelf.</h1>
      
     <Link to='/listedBook'> <button className="btn btn-success text-white">View The List</button></Link>
    </div>
  </div>
</div>
        </div>
